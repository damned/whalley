...
exports.fetch_cards = function(username, password, on_success, on_error) {
  ...
  query = "/api/v2/projects/tw_dot_com/cards/execute_mql.json?mql=select%20name,%20number,%20status%20where%20type%20=%20story%20and%20status%20>=%20Next%20and%20status%20<%20\"Done%20(Deployed%20to%20Live)\""
  https.get({ host: host, path: query, headers: header }, function(res) {
