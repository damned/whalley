...
exports.convert = function(source_data, target_code) {
  ...
  source_version_ordinal = version_ordinal(source_data.structure_version, "source structure_version to convert from")
  target_version_ordinal = version_ordinal(target_code, "target_version to convert to")
