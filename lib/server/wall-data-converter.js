...
exports.convert = function(source_data, target_code) {
  ...
  var source_code = source_data.structure_version;
  check_version(target_code, "target_version to convert to");
  check_version(source_code, "source structure_version to convert from");

  if (source_code === target_code) {
    return source_data;
  }
  source_version_ordinal = version_ordinal(source_code)
  target_version_ordinal = version_ordinal(target_code)
...
function version_ordinal(version_code) {
