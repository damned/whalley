...
whalley.in_memory = {
    write_property: function (id, key, value) {
      if (in_memory_data[id] === undefined) {
        in_memory_data[id] = {};
      }
      in_memory_data[id][key] =  value;
    },
    read_property: function (id, key) {
      if (in_memory_data[id] === undefined) {
        in_memory_data[id] = {};
      }
      return in_memory_data[id][key];
    },
    write: function (key, value) {
      if (in_memory_data['misc'] === undefined) {
        in_memory_data['misc'] = {};
      }
      in_memory_data['misc'][key] = value
    },
    read: function (key) {
      return in_memory_data['misc'][key];
    },
    reset: function () { 
      in_memory_data = {};
      in_memory_data['misc'] = {};
    ...
    json: function () { 
      return JSON.stringify(in_memory_data, undefined, 2);
    }
};
whalley.in_memory.reset();
...
var load_local_cards = function() {
  ...
  if (local_card_ids === null || local_card_ids === '' || local_card_ids === undefined) {
    return;
  };
...
var store = whalley.in_memory;

setInterval(function() { if (cards.length > 0) save_cards(); }, 5000);
