...
whalley.image_capture_view = function(navigator) {
  ...
  function getUserMediaFallback(a, b, c) {
    console.log('Not actually getting user media: webcam not supported')
  }

  navigator.getMedia = (navigator.getUserMedia ||
      navigator.webkitGetUserMedia ||
      navigator.mozGetUserMedia ||
      navigator.msGetUserMedia || getUserMediaFallback);
